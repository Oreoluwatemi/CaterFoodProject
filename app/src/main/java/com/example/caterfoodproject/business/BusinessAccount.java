...
import com.example.caterfoodproject.user.HomeActivity;
import com.example.caterfoodproject.user.LoginActivity;
 ...
 * Use the {@link BusinessAccount#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BusinessAccount extends Fragment {
    String firstName;
    String lastName;
    String email;
    String phoneNumber;
    ...
    public static BusinessAccount newInstance(String param1, String param2) {
        BusinessAccount fragment = new BusinessAccount();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        var rootView = inflater.inflate(R.layout.fragment_business_account, container, false);
